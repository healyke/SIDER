...
new.data.test <- setTdfEst(species = "Meles_meles", 
                             habitat = "terrestrial", 
...
new.data.dummy <- setTdfEst(species = "Varanus_komodoensis", 
                             habitat = "terrestrial", 
                             taxonomic.class = "mammalia", 
                             tissue = "NA", 
                             diet.type = "omnivore", 
...
\section{Formatting the new data: \texttt{tdfMulClean}}
...
```{r format_data}
tdf_data_c <- tdfMulClean(new.data = new.data.test, 
                          data = TESIR.data, 
...
\section{Running the analysis: \texttt{tdfMulClean}}
...
```{r eval_glmm}
TDF_est.c <- tdfMcmcglmm(mulTree.data = tdf_data_c, 
                         formula = formula.c, 
