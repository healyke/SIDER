...
# here we set to R's temporary directory but you would normally use 
# your local folder for your project. We keep track of the original 
# directory and change back again at the end of this example.
