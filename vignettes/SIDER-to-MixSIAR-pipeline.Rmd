...
original_tdfs <- load_discr_data(filename = discr_filename, mix)
...
jags_1 <- run_model(run="short", mix, source, original_tdfs, model_filename, 
...
extra_errors_tdfs <- original_tdfs
