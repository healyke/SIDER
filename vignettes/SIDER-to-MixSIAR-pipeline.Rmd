...
```{r derbridge-tdfs}
discr3 <- discr2
discr3$mu[,"Meand13C"] <- 1.97
discr3$mu[,"Meand15N"] <- 3.04

discr3$sig2[,"SDd13C"] <- 0.70
discr3$sig2[,"SDd15N"] <- 0.31


jags.4 <- run_model(run="short", mix, source, discr3, model_filename, 
                    alpha.prior = 1, resid_err, process_err)
...
discr4 <- discr2
discr4$mu[,"Meand13C"] <- fox_data$delta13C
discr4$mu[,"Meand15N"] <- fox_data$delta15N
