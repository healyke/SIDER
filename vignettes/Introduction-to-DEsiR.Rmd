---
title: "Introduction to DEsiR"
author: "Kevin Healy"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Introduction to DEsiR}
...
To install \texttt{DEsiR} its dependency \href{https://github.com/TGuillerme/mulTree}{\texttt{MulTree} package} must first be installed directly from GitHub using the following:
...
Following this you can then install \texttt{DEsiR} directly from GitHub using the following:
```{r install_DEsiR, results="hide", message=FALSE}
...
set.tef.est checks for the presence of the following data:
