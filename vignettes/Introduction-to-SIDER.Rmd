...
To install **`SIDER`**, its dependency **`mulTree`** must first be installed directly from GitHub. If you have not sone so you can use the following:
...
This data is used to run a model and impute an isotopic value for the new species. We search this data using the `scrumpSider` function.
