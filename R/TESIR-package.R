...
#' Fractionation Estimation Using Phylogenetic Inference.
#' 
...
#' @docType package
#'
#' @author Kevin Healy <heaylke@tcd.ie> & Thomas Guillerme <guillert@tcd.ie> & Sean BA Kelly <kellys17@tcd.ie> & Andrew L Jackson <a.jackson@tcd.ie>
#' 
#' @references 
#' 
#' @keywords 
