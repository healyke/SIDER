...
##check class data
if(is.null(taxonomic.class) == TRUE){warning("Data for taxonomic.class missing")
...
if(is.null(source.iso.13C) & is.null(source.iso.15N) == TRUE){warning("No source isotopic data")
