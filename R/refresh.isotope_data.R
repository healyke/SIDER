#Internal utility function for refreshing the istotop_data dataset (not
#exported) This function rapidly updates the isotope_data.rda file once one
#updates the TESIR_data.csv file.
